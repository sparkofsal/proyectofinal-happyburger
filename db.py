...
Módulo para manejar la conexión a SQLite y crear tablas si no existen.
"""
...
def get_connection():
    ...
    conn.row_factory = sqlite3.Row  # para leer columnas por nombre
    return conn
...
def init_db():
    ...
    SQL básico y claro, como pide el avance.
    """
    conn = get_connection()
    cursor = conn.cursor()
